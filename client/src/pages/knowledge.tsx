...
const categories = [
  ...
  { id: "Menstruation", title: "月经", subtitle: "生理周期", icon: Baby, color: "from-rose-400 to-red-500" },
  { id: "Health_and_Wellness", title: "健康与保健", subtitle: "身心福祉", icon: Heart, color: "from-green-400 to-lime-500" },
  { id: "Anatomy", title: "身体构造", subtitle: "解剖科普", icon: Users, color: "from-blue-400 to-indigo-500" },
  { id: "UTIs", title: "尿路感染", subtitle: "预防治疗", icon: ShieldAlert, color: "from-yellow-400 to-orange-500" },
